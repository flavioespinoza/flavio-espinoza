...
const elements = [
  ...
  create_element(
    'power',
    ['transition', 'react', 'development', 'power'],
    'transition',
    'Power',
    'Pw',
    '( f, p )',
    ...
    [],
    'Power IOT map',
    'IOT Map of power distribution equipment for the City of Chicago.'
  ),

  create_element(
    'lighting',
    ['transition', 'react', 'development', 'lighting'],
    'transition',
    'Lighting',
    'Lg',
    '( f, p )',
    ...
    [],
    'Ligting IOT map',
    'IOT Map of distributed lighting controls for the City of Boston.'
  ),
